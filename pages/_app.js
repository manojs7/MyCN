...
function MyApp({ Component, pageProps: { session, ...pageProps } }) {
  ...
  // Connect to MongoDB when the app mounts
  useEffect(() => {
  }, []);
  ...
  return (
    <>
      <Head>
        ...
        <script
          async
          src="https://www.googletagmanager.com/gtag/js?id=G-LTMMZTYB0W"
        ></script>
        <script
          dangerouslySetInnerHTML={{
            __html: `
        ...
        <script
          async
          src="https://www.googletagmanager.com/gtag/js?id=G-3PQ8CP4BNB"
        ></script>
        <script
          dangerouslySetInnerHTML={{
            __html: `
