...
import CustomizeNinjaBox from '$lib/ninja-box/CustomizeNinjaBox';
...
export default function Checkprice() {
    return (<>
        ...
        src={`https://securegw.paytm.in/merchantpgpui/
            checkoutjs/merchants/CaterN17180271203216.js`} 
            onload="onScript Load();"/>
        <NewNavBar />
        <Navbar />
        <CustomizeNinjaBox />
        {/* <Footer /> */}
