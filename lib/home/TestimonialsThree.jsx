                    ...
                    <div className="pb-4">
                        ...
                        <Slider {...settings}>
                            <div className="">
                                <div className="review-card row p-2">
                                    <div className="profile-img col-3">
                                        <a href="https://goo.gl/maps/hLUoXjyE4yGQdjUH7" target="_blank"><img src="https://lh3.googleusercontent.com/a-/AD5-WCmmUr9Vtx6TbYVjrPmlJNl-3OQz-uTJQxs8CvQrGck=w60-h60-p-rp-mo-br100" /></a>
                                    </div>
                                    <div className="text-section col-9 ps-4">
                                        <a href="https://goo.gl/maps/hLUoXjyE4yGQdjUH7" target="_blank"><img id="img1" src="google logo.png" /></a>
                                        <img src="Star.svg" />

                                        <a href="https://goo.gl/maps/hLUoXjyE4yGQdjUH7" target="_blank"><p id="title">Robin Max Almeida</p></a>
                                        <a href="https://goo.gl/maps/hLUoXjyE4yGQdjUH7" target="_blank"><p id="description">Ordered food at the last moment for them and turned out be the best decision. Fistly punctuality and then is the quality of food. No regrets to hold people enjoyed every bit of it. Would definetely recommend them.</p></a>
                                    </div>
                                </div>
                            </div>
                            <div className="">
                                <div className="review-card row p-2">
                                    <div className="profile-img col-3">
                                        <a href="https://goo.gl/maps/ozRLQGGgoRqfcyy69" target="_blank"><img src="https://lh3.googleusercontent.com/a-/AD5-WCnbK8B8AsuYm9zlzWAwXwT7Sq3n3CtaRj1lMDEdcQ=w60-h60-p-rp-mo-br100" /></a>
                                    </div>
                                    <div className="text-section col-9 ps-4">
                                        <a href="https://goo.gl/maps/ozRLQGGgoRqfcyy69" target="_blank"><img id="img1" src="google logo.png" /></a>
                                        <img src="Star.svg" />
                                        <a href="https://goo.gl/maps/ozRLQGGgoRqfcyy69" target="_blank"><p id="title">Naresh Thawal</p></a>
                                        <a href="https://goo.gl/maps/ozRLQGGgoRqfcyy69" target="_blank"><p id="description">Overall good experience with your team and cooperation.
                            ...
                            <div className="">
                                <div className="review-card row p-2">
                                    <div className="profile-img col-3">
                                        <a href="https://goo.gl/maps/EPdywe9Fw361Tn7H9" target="_blank"><img src="https://lh3.googleusercontent.com/a-/AD5-WClycg2JiOEDl3Yntgm2GM8qt-HpCFdC3fgn5fRzJQ=w60-h60-p-rp-mo-br100" /></a>
                                    </div>
                                    <div className="text-section col-9 ps-4">
                                        <a href="https://goo.gl/maps/EPdywe9Fw361Tn7H9" target="_blank"><img id="img1" src="google logo.png" /></a>
                                        <img src="Star.svg" />
                                        <a href="https://goo.gl/maps/EPdywe9Fw361Tn7H9" target="_blank"><p id="title">Hari om Gangwar</p></a>
                                        <a href="https://goo.gl/maps/EPdywe9Fw361Tn7H9" target="_blank"><p id="description">I had a snack box party for 90 kids with CaterNinja.
                            ...
                            <div className="">
                                <div className="review-card row p-2">
                                    <div className="profile-img col-3">
                                        <a href="https://goo.gl/maps/aWFj7rH5y167e2ZT9" target="_blank"><img src="https://lh3.googleusercontent.com/a-/AD5-WCn6Oz63RVaH6MtoCWEkp_Mo2loMC-yvqQFW7ywTETw=w60-h60-p-rp-mo-br100" /></a>
                                    </div>
                                    <div className="text-section col-9 ps-4">
                                        <a href="https://goo.gl/maps/aWFj7rH5y167e2ZT9" target="_blank"><img id="img1" src="google logo.png" /></a>
                                        <img src="Star.svg" />
                                        <a href="https://goo.gl/maps/aWFj7rH5y167e2ZT9" target="_blank"><p id="title">Ananya Rai</p></a>
                                        <a href="https://goo.gl/maps/aWFj7rH5y167e2ZT9" target="_blank"><p id="description">I ordered ninja buffet service for the third time. This time food was best out of all 3 times. All my guests liked the food. There was no extra oil and masala. The food was like a home cooked meal. Dahi vadas we’re too good nice, soft and spongy. The service of servers was completely fuss free and excellent.</p></a>
                                    </div>
                                </div>
                            </div>
                            <div className="">
                                <div className="review-card row p-2">
                                    <div className="profile-img col-3">
                                        <a href="https://goo.gl/maps/r48z1rwaeozFXPLK8" target="_blank"><img src="https://lh3.googleusercontent.com/a-/AD5-WCkS3_VMomayA5xpyA8L2Jr2g3BIKxCIyACmgnWy=w60-h60-p-rp-mo-br100" /></a>
                                    </div>
                                    <div className="text-section col-9 ps-4">
                                        <a href="https://goo.gl/maps/r48z1rwaeozFXPLK8" target="_blank"><img id="img1" src="google logo.png" /></a>
                                        <img src="Star.svg" />
                                        <a href="https://goo.gl/maps/r48z1rwaeozFXPLK8" target="_blank"><p id="title">Aditi Shah</p></a>
                                        <a href="https://goo.gl/maps/r48z1rwaeozFXPLK8" target="_blank"><p id="description">Food came hot in their nicely packed containers and packaging looked premium and very unique.
                            ...
                            <div className="">
                                <div className="review-card row p-2">
                                    <div className="profile-img col-3">
                                        <a href="https://goo.gl/maps/s93Zi829wxXGyuH36" target="_blank"><img src="https://lh3.googleusercontent.com/a-/AD5-WCm1bU5qWaR52q02TXVX0-BsWPl-P84gS8pO0JKhcw=w60-h60-p-rp-mo-br100" /></a>
                                    </div>
                                    <div className="text-section col-9 ps-4">
                                        <a href="https://goo.gl/maps/s93Zi829wxXGyuH36" target="_blank"><img id="img1" src="google logo.png" /></a>
                                        <img src="Star.svg" />
                                        <a href="https://goo.gl/maps/s93Zi829wxXGyuH36" target="_blank"><p id="title">Sowmya Ravindranath</p></a>
                                        <a href="https://goo.gl/maps/s93Zi829wxXGyuH36" target="_blank"><p id="description">Myself and my guests enjoyed the food. The packaging was excellent and it was hassle free on my side. I could enjoy the party without any stress. 😊 Thank you very much for your wonderful service.</p></a>
                                    </div>
                                </div>
                            </div>
                            <div className="">
                                <div className="review-card row p-2">
                                    <div className="profile-img col-3">
                                        <a href="https://goo.gl/maps/QqbHgAUF3ofUc5yt8" target="_blank"><img src="https://lh3.googleusercontent.com/a-/AD5-WCnUB65nzQv8Ljg2xSs_OwLU5VotOzaQ5fXMc6qi=w60-h60-p-rp-mo-br100" /></a>
                                    </div>
                                    <div className="text-section col-9 ps-4">
                                        <a href="https://goo.gl/maps/QqbHgAUF3ofUc5yt8" target="_blank"><img id="img1" src="google logo.png" /></a>
                                        <img src="Star.svg" />
                                        <a href="https://goo.gl/maps/QqbHgAUF3ofUc5yt8" target="_blank"><p id="title">Swati Singh</p></a>
                                        <a href="https://goo.gl/maps/QqbHgAUF3ofUc5yt8" target="_blank"><p id="description">We have ordered for 30 people , Fixed menu and we  must say It was very easy and time saving decision. Food was yummy, Packaging was very nice.
