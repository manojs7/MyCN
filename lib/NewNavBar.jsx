        ...
        <div className='mobileNavbar'>
            <nav className="navbar py-3">
                <div className="container-fluid">
                    ...
                    <Link href='/'><a><img id={styles.midLogo} src='/CaterNinja logo/caterninja.webp' width="119px" height="24px" /></a></Link>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto my-2 mb-lg-0">
                            ...
                            <li className="nav-item d-flex align-items-center">
                                <img id={styles.navImg} src='buffet.png' height="33px" width="52.8px" />
            ...
            {/* <div className={styles.navContainer}>
                <div className={styles.contents}>
                    ...
                    <div>
                        <img src='/CaterNinja logo/caterninja.webp' width="119px" height="24px" />
                    </div>
                    <div>
