    ...
    <div className={styles.float_nav_container}>
      ...
      <div className={styles.float_nav_button}>
        ...
        <div className={styles.bottomBtn}>
          <div id="float1btn">
            <img onClick={() => (window.location.href = "/customizeNinjaBox")} src="Group 894.png" width="80"  />
          </div>
          <div>
            <img onClick={() => (window.open('tel:08047176666'))} src="Group 1073.png" width="80"  />
          </div>
          <div>
            <img onClick={() => (window.location.href = "https://api.whatsapp.com/send?phone=917738096313&text=Hi")} src="Group 1074.png" width="80"  />
          </div>
        </div>
      </div>
