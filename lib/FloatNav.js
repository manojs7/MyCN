    ...
    <div className={styles.float_nav_container}>
      ...
      <div className={styles.float_nav_button}>
        ...
        <div className={styles.bottomBtn}>
          ...
          <div>
            <a href="tel:08047176666" id="call"><img  src="Group 1073.png" width="80"  /></a>
          </div>
          <div>
          <a href="https://api.whatsapp.com/send?phone=917738096313&text=Hi Need Menu and Prices" target="_blank" id="wp"><img src="Group 1074.png" width="80"  /></a>
          </div>
        </div>
      </div>
